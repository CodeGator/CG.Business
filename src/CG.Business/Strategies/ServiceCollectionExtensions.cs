...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// purpose of registering strategy related abstractions with the 
        ...
        /// <summary>
        /// This method is called, internally, to register the specified strategy section.
        /// </summary>
        /// <param name="serviceCollection">The service collection to use 
        /// for the operation.</param>
        ...
        /// <returns>the value of the <paramref name="serviceCollection"/>
        /// parameter, for chaining calls together.</returns>
        internal static IServiceCollection ProcessStrategySection(
           this IServiceCollection serviceCollection,
           string strategyName,
           IConfiguration configuration,
